            ...
            <table className="w-full text-left text-xs text-slate-200">
              <thead className="bg-slate-900/90 text-amber-300 font-heading text-xs uppercase tracking-wider">
                <tr>
                  ...
                  <th className="py-3.5 px-4 text-center">नोंद (Status)</th>
                </tr>
              </thead>
                ...
                {filteredRecords.map((item) => (
                  <tr key={item.id} className="hover:bg-amber-950/20 transition-colors">
                    ...
                    <td className="py-3 px-4 text-center">
                      <span className="px-2.5 py-0.5 rounded-md bg-emerald-950/60 text-emerald-400 border border-emerald-500/30 text-[10px] font-mono inline-flex items-center space-x-1">
